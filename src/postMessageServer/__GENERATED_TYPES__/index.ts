 ...
 *
 */
export type  = Hidden | Address | NewAccount | Transaction | ChainId | SignedTypedData | Keyfile | ImportMnemonicOptions | AccountMnemonicOptions | HexString | Accounts | Wallets | AccountExists | SignedTypedDataResult | Mnemonic | StringDoaGddGA;
...
export type SignTransaction = (transaction: Transaction, chainId: ChainId) => Promise<HexString>;
export type SignTypedData = (typedData: SignedTypedData, address: Address, chainId: ChainId) => Promise<SignedTypedDataResult>;
export type ImportKeyfile = (keyfile: Keyfile) => Promise<Address>;
...
export type Sign = (dataToSign: HexString, address: Address, chainId: ChainId) => Promise<HexString>;
